...
You can provision xref:integrations/rancher/node-driver/rke2-cluster.adoc[RKE2] clusters in Rancher using the built-in Harvester Node Driver. Harvester provides <<#_load_balancer_support,load balancer>> and Harvester cluster xref:integrations/rancher/csi-driver.adoc[storage passthrough] support to the guest Kubernetes cluster.

...
For more information about the incompatibility, see xref:backup-restore/integration-built-in.adoc#_scheduled_vm_backups_snapshots[Scheduled virtual machine backups and snapshots].